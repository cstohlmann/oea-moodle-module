...
# 1) install notebooks
eval "az synapse notebook import --workspace-name $synapse_workspace --name Moodle_example --spark-pool-name spark3p2sm --file @$this_file_path/notebook/Moodlle_example.ipynb --only-show-errors"
